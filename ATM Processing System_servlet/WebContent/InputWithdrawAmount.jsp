...
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Enter the Amount" aria-label="Recipient's username" aria-describedby="basic-addon2" name="Amount">
  <span ><button type="submit" class="btn btn-info">Enter </button></span>
</div>
</form>
